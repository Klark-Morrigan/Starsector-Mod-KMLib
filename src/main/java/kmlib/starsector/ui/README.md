...
| [`render/gl`](render/gl/) | GL | the drawing surface itself and the primitives every pass below composes: [fills](render/gl/UiFill.java), [borders](render/gl/UiBoxes.java), [sprites](render/gl/UiSprite.java), [scissor](render/gl/UiScissor.java), a [label](render/gl/LabelRenderer.java), a triangle, and the [state guard](render/gl/GlStateGuard.java). Only three of these actually name `org.lwjgl.opengl`; the subject packages below reach GL through them rather than directly |
