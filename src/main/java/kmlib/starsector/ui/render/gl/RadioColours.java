 ...
 * {@link kmlib.starsector.ui.widgets.tabs.VanillaTabColours} groups a tab strip's shades - and both roles may resolve to one accent (the common case), just as the
