...
public interface IntelScreenView {
     ...
     *         intel tab is not the one showing, the panel is not laid out yet, or the preview is
     *         blanked (a large-description item hides it). A non-null result is exactly the signal
     *         that the visor is present.
     */
