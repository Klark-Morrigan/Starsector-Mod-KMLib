...
/**
 * The sort vocabulary a consumer offers its picker: the modes in the order the selector stacks its
 ...
 * loose parameters that could be mixed from different consumers.
 *
