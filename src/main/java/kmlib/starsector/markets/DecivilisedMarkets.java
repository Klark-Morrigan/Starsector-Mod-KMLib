 ...
 *
 * <p>A decivilised planet is inhabited-but-unowned: it exists and the player can
 * know it exists, yet no faction holds it. This is a single source of truth for
 * "is there a revealed dead colony here", answering both the per-system query
 * and the sector-wide collection so every caller reads decivilisation the same
 * way.
 *
 ...
 * state. Matches {@link Markets}'s shape, and is null-argument defensive like
