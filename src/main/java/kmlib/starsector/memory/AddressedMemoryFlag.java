...
/**
 * One boolean held once per {@link MemoryKeyAddress} rather than once per save: the holder declares its
 * base key and its default here, and every read and write names the address whose slot it means. The
 * addressed key is composed inside, so a holder states what it stores and never how the key is spelled.
 *
