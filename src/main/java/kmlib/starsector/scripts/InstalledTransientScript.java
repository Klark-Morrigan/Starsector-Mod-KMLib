 ...
 * state - would hand it back on a widget the installer never touched. Holding the instance is what
 * keeps a removal to what this installer actually put there.
 *
 ...
 *
 * <p>Not for a script the installing mod owns outright. Those are safely removed by class through
 * {@link SectorScripts}, no sibling mod having one, and a slot for them would be ceremony over a
 * one-line call.
 *
