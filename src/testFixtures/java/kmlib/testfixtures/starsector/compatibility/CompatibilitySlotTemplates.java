...
public final class CompatibilitySlotTemplates {
    ...
    private static final Map<String, String> TEMPLATES_BY_KEY = Map.ofEntries(
        ...
        Map.entry("compatibility_notice_diagnosis_unknown_version", "diagnose-unknown{%s|%s|%s|%s|%s}"),
        Map.entry("compatibility_notice_diagnosis_older_version", "diagnose-older{%s|%s|%s}"),
        Map.entry("compatibility_notice_diagnosis_newer_version", "diagnose-newer{%s|%s|%s}"),
        Map.entry("compatibility_notice_action_update", "do-update"),
        Map.entry("compatibility_notice_action_downgrade_or_wait", "do-choose{%s|%s|%s}"),
