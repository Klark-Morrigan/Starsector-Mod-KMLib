...
class CampaignMapTransformTest {
    ...
    class BuildUiOrthoProjectionMatrix {
        ...
        void producesTheOrthoTheCampaignUiSetsUp() {
            ...
            assertThat(projection).usingComparatorWithPrecision(MATRIX_TOLERANCE)
                .containsExactly(
                    0.00125f, 0f, 0f, 0f,
                    0f, 0.002f, 0f, 0f,
                    0f, 0f, -2f / 12000f, 0f,
        ...
        void unprojectsTheViewportCentreToTheScreenCentre() {
            ...
            assertThat(world.x)
                .isCloseTo(SCREEN_WIDTH / 2f, TOLERANCE);
            assertThat(world.y)
                .isCloseTo(SCREEN_HEIGHT / 2f, TOLERANCE);
        }
        ...
        void unprojectsIntoUiUnitsWhenTheViewportIsPixelScaled() {
            ...
            var pixelScaledViewport = new int[] {
                0,
                0,
                (int) SCREEN_WIDTH * PIXEL_SCALE,
                (int) SCREEN_HEIGHT * PIXEL_SCALE};
            ...
            assertThat(world.x)
                .isCloseTo(SCREEN_WIDTH, TOLERANCE);
            assertThat(world.y)
                .isCloseTo(SCREEN_HEIGHT, TOLERANCE);
        }
    }
    ...
    class CaptureFromMapPass {
        ...
        void composesAReadModelviewIntoASnapshotThatUnprojects() {
            ...
            // the factor did.
            var world = transform.unprojectToWorld(
                SCREEN_WIDTH * PIXEL_SCALE / 2f,
                SCREEN_HEIGHT * PIXEL_SCALE / 2f);

            assertThat(world.x)
                .isCloseTo((SCREEN_WIDTH / 2f - PAN_X) / MAP_ZOOM, TOLERANCE);
            assertThat(world.y)
                .isCloseTo((SCREEN_HEIGHT / 2f - PAN_Y) / MAP_ZOOM, TOLERANCE);
        }
    ...
    class Construction {
        ...
        void rejectsAWrongSizedModelviewMatrix() {
            ...
            assertThatIllegalArgumentException()
                .isThrownBy(() -> new CampaignMapTransform(
                    new float[] {1f},
                    IDENTITY_MATRIX,
                    VIEWPORT,
                    NO_SCALE));
    ...
    class UnprojectToWorld {
        ...
        void undoesAPanBakedIntoTheModelviewMatrix() {
            ...
            var transform = new CampaignMapTransform(
                buildTranslationMatrix(10f, 20f),
                IDENTITY_MATRIX,
                VIEWPORT,
                NO_SCALE);
            ...
            assertThat(world.x)
                .isCloseTo(-10f, TOLERANCE);
            assertThat(world.y)
                .isCloseTo(-20f, TOLERANCE);
        }
        ...
        void returnsNoPointWhenTheFactorIsZero() {
            ...
            assertThat(transform.unprojectToWorld(50f, 50f))
                .isNull();
        }
        ...
        void returnsNoPointWhenTheTransformCannotBeInverted() {
            ...
            var transform = new CampaignMapTransform(
                IDENTITY_MATRIX,
                new float[IDENTITY_MATRIX.length],
                VIEWPORT,
                NO_SCALE);
