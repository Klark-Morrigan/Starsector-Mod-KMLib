...
class HotkeyStyleTest {
    ...
    class UnderlineThickness {
        ...
        void HotkeyStyle_underlineThickness_floorsAtZeroWhenNegative() {
            ...
            assertThat(style.underlineThickness()).isCloseTo(0f, within(TOLERANCE));
        }
    }
    ...
    class ComputeUnderlineBox {
        ...
        void HotkeyStyle_computeUnderlineBox_spansTheKeyBoxAndStandsTheStyledThickness() {
            ...
            var box = new HotkeyStyle(GOLD, true, 2f, 3f).computeUnderlineBox(KEY_BOX);

            assertThat(box.x()).isCloseTo(KEY_BOX.x(), within(TOLERANCE));
            assertThat(box.width()).isCloseTo(KEY_BOX.width(), within(TOLERANCE));
            assertThat(box.height()).isCloseTo(2f, within(TOLERANCE));
        }
        ...
        void HotkeyStyle_computeUnderlineBox_hangsTheStyledGapBelowTheKeyBox() {
            ...
            assertThat(box.y() + box.height()).isCloseTo(KEY_BOX.y() - 3f, within(TOLERANCE));
        }
        ...
        void HotkeyStyle_computeUnderlineBox_liftsTheUnderlineIntoTheBoxOnANegativeGap() {
            ...
            var box = new HotkeyStyle(GOLD, true, 1f, -2f).computeUnderlineBox(KEY_BOX);

            assertThat(box.y() + box.height()).isCloseTo(KEY_BOX.y() + 2f, within(TOLERANCE));
        }
    }
}
