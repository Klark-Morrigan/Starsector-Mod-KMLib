...
final class TabStyleTest {
    ...
    class HeaderBandHeight {
        ...
        void headerBandHeightCarriesThePositiveValueThrough() {
            assertThat(new TabStyle(17f).headerBandHeight()).isCloseTo(17f, within(TOLERANCE));
        }
        ...
        void headerBandHeightFloorsAtZeroWhenNegative() {
            ...
            assertThat(new TabStyle(-8f).headerBandHeight()).isCloseTo(0f, within(TOLERANCE));
        }
        ...
        void headerBandHeightKeepsZeroAsABandlessStyle() {
            ...
            assertThat(new TabStyle(0f).headerBandHeight()).isCloseTo(0f, within(TOLERANCE));
        }
    }
}
