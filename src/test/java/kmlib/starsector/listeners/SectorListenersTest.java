package kmlib.starsector.listeners;
 ...
 * here is what they mean, so a change to the shape fails once rather than in every such suite at
 * whatever depth each happened to assert.
 */
final class SectorListenersTest {
