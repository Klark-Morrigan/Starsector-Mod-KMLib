...
class PointsTest {
    ...
    class ComputeSignedOffsetFromLine {
        ...
        void computeSignedOffsetFromLineIsPositiveOnTheNormalSide() {
            ...
            assertThat(Points.computeSignedOffsetFromLine(new double[] {8, 0}, 5, 0, 1, 0))
                    .isEqualTo(3.0);
        }

        @Test
        void computeSignedOffsetFromLineIsNegativeOnTheFarSide() {
            assertThat(Points.computeSignedOffsetFromLine(new double[] {2, 0}, 5, 0, 1, 0))
                    .isEqualTo(-3.0);
        }

        @Test
        void computeSignedOffsetFromLineIsZeroOnTheLine() {
            assertThat(Points.computeSignedOffsetFromLine(new double[] {5, 100}, 5, 0, 1, 0))
                    .isZero();
        }
        ...
        void computeSignedOffsetFromLineScalesWithANonUnitNormal() {
            ...
            assertThat(Points.computeSignedOffsetFromLine(new double[] {8, 0}, 5, 0, 2, 0))
                    .isEqualTo(6.0);
        }
    }
