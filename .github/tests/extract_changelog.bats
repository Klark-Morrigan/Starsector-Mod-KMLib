#!/usr/bin/env bats
# Unit tests for the extract-changelog composite action's script.
#
# Requires bats-core: https://github.com/bats-core/bats-core
# Run from the KMLib mod root: bats .github/tests/extract_changelog.bats

SCRIPT="$BATS_TEST_DIRNAME/../actions/extract-changelog/scripts/extract_changelog.sh"
